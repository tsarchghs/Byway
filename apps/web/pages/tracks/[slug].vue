<template>
  <a-space direction="vertical" size="large" style="width:100%">
    <a-breadcrumb>
      ...
      <a-breadcrumb-item><NuxtLink to="/tracks">Tracks</NuxtLink></a-breadcrumb-item>
    ...
    <a-typography-title :level="3">Included courses</a-typography-title>
...
onMounted(async()=>{
  data.value = await $fetch(`/plugins/students-internal/api/tracks/${route.params.slug}`)
})
</script>
