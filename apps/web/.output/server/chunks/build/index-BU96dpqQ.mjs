...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const events = ref([]);
    const rangeStart = ref(void 0);
    const rangeEnd = ref(void 0);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "institution-calendar" }, _attrs))} data-v-cbe53188>`);
      _push(ssrRenderComponent(_component_a_page_header, { title: "Institution Schedule" }, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_a_menu_item, { key: "overview" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<a${ssrRenderAttr("href", navHref("overview"))} data-v-cbe53188${_scopeId4}>Overview</a>`);
                            } else {
                              return [
                                createVNode("a", {
                        ...
                        if (currentRole.value === "admin") {
                          _push4(ssrRenderComponent(_component_a_menu_item, { key: "departments" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<a${ssrRenderAttr("href", navHref("departments"))} data-v-cbe53188${_scopeId4}>Departments</a>`);
                              } else {
                                return [
                                  createVNode("a", {
                        ...
                        _push4(ssrRenderComponent(_component_a_menu_item, { key: "classrooms" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<a${ssrRenderAttr("href", navHref("classrooms"))} data-v-cbe53188${_scopeId4}>Classrooms</a>`);
                            } else {
                              return [
                                createVNode("a", {
                        ...
                        _push4(ssrRenderComponent(_component_a_menu_item, { key: "people" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<a${ssrRenderAttr("href", navHref("people"))} data-v-cbe53188${_scopeId4}>People Directory</a>`);
                            } else {
                              return [
                                createVNode("a", {
                                  href: navHref("people")
                        ...
                        _push4(ssrRenderComponent(_component_a_menu_item, { key: "catalog" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<a${ssrRenderAttr("href", navHref("catalog"))} data-v-cbe53188${_scopeId4}>Catalog</a>`);
                            } else {
                              return [
                                createVNode("a", {
                        ...
                        _push4(ssrRenderComponent(_component_a_menu_item, { key: "calendar" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<a${ssrRenderAttr("href", navHref("calendar"))} data-v-cbe53188${_scopeId4}>Calendar</a>`);
                            } else {
                              return [
                                createVNode("a", {
                        ...
                        _push4(ssrRenderComponent(_component_a_menu_item, { key: "assignments" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<a${ssrRenderAttr("href", navHref("assignments"))} data-v-cbe53188${_scopeId4}>Assignments</a>`);
                            } else {
                              return [
                                createVNode("a", {
                  ...
                  _push3(ssrRenderComponent(_component_a_date_picker, {
                    ...
                    "onUpdate:value": ($event) => rangeStart.value = $event,
                    placeholder: "From"
                  }, null, _parent3, _scopeId2));
                  _push3(ssrRenderComponent(_component_a_date_picker, {
                    value: rangeEnd.value,
                    "onUpdate:value": ($event) => rangeEnd.value = $event,
                    placeholder: "To"
                  }, null, _parent3, _scopeId2));
            ...
            _push2(ssrRenderComponent(_component_a_row, { gutter: 16 }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                                ...
                                bodyCell: withCtx(({ column, record }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    if (column.dataIndex === "title") {
                                      _push6(`<a${ssrRenderAttr("href", eventLink(record))} data-v-cbe53188${_scopeId5}>${ssrInterpolate(record.title)}</a>`);
                                    } else {
                                      _push6(`<!---->`);
                                    }
                                  } else {
                  ...
                  _push3(ssrRenderComponent(_component_a_col, { span: 10 }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_a_card, {
                          size: "small",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../plugins/institution-portal/nuxt/pages/calendar/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cbe53188"]]);

export { index as default };
//# sourceMappingURL=index-BU96dpqQ.mjs.map
