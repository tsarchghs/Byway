...
INSERT INTO "new_TeacherProfile" ("avatarUrl", "bio", "createdAt", "id", "payoutEmail", "subjects", "verified") SELECT "avatarUrl", "bio", "createdAt", "id", "payoutEmail", "subjects", "verified" FROM "TeacherProfile";
